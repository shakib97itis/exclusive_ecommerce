...
{/* absolute bottom-0 w-full translate-y-[110%]  */}

        {/* ADD TO CART BUTTON */}
        <button className="bg-button absolute bottom-0 left-0 hover:bg-button/80 title-16-medium cursor-pointer rounded-b px-3 py-2 text-white transition-all duration-300 w-full ">
          Add to Cart
        </button>
      </div>
