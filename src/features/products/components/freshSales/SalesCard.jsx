  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <div className="group relative mb-4 flex min-h-60 w-full items-center justify-center overflow-hidden rounded bg-gray-200 px-10 py-9">
        ...
        {/* ADD TO CART BUTTON */}
        <button className="bg-button cursor-pointer hover:bg-button/80 title-16-medium absolute bottom-0 w-full translate-y-[110%] rounded-b px-3 py-2 text-white transition-all duration-300 group-hover:translate-y-0">
          Add to Cart
        </button>
      </div>
