...
const SalesCard = () => {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="mb-4 flex min-h-60 w-full items-center justify-center bg-gray-200 px-10 py-9">
        <img
          src={consoleImage}
          alt="Product"
...
const example = () => {
  ...
  return (
    <button className="mt-3 w-full rounded-md bg-blue-600 px-3 py-2 text-sm text-white transition-colors duration-300 hover:bg-blue-700 sm:mt-4 sm:px-4 sm:py-2 sm:text-base">
      Add to Cart
    </button>
  );
};
